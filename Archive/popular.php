...
echo('<div class="wrapper">
  		...
  		<div id="content">
			<div id="comments">
        		<h1>The Most Popular Points of the Day</h1>
        		<ul class="commentlist">');
$result = mysql_query("SELECT  body, cat_id, up, down, id, user_id, time_stamp FROM content WHERE up>20 ORDER BY up DESC, down ASC");
