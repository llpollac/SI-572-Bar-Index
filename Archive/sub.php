...
echo('<h1>Points of the Day Submitted By '.$user_name.' </h1>
        		<ul class="commentlist">');
$user_id=$_SESSION['id'];  
     		
$result4 = mysql_query("SELECT  body, cat_id, up, down, id, user_id, time_stamp FROM content WHERE user_id=$user_id");
