...
echo('<div class="wrapper">
  		...
  		<div id="content">
			<div id="comments">
        		<h1>Featured Points of the Day</h1>
        		<ul class="commentlist">');
$result = mysql_query("SELECT  body, cat_id, up, down, id, user_id, time_stamp FROM content WHERE f_id IS NOT NULL ORDER BY f_id DESC");
